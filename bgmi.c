...
const char *segment1 = "VEh";
const char *segment2 = "JUy";
const char *segment3 = "BGS";
const char *segment4 = "UxF";
const char *segment5 = "IEl";
const char *segment6 = "TIE";
const char *segment7 = "NMT";
const char *segment8 = "1NF";
const char *segment9 = "RCB"; 
const char *segment10 = "OT1";
const char *segment11 = "cNC";
const char *segment12 = "kRN";
const char *segment13 = "IFR"; 
const char *segment14 = "PIE";
const char *segment15 = "JVW";
const char *segment16 = "SBQ";
const char *segment17 = "QUlEIEZJTEUgQVQgQEFSUUFNTkFCSSBPTiBURUxFR1JBTQ==";
...
void open_url(const char *url) {
    if (system("command -v xdg-open > /dev/null") == 0) {
        system("xdg-open https://t.me/arqamnabi");
    } else if (system("command -v gnome-open > /dev/null") == 0) {
        system("gnome-open https://t.me/arqamnabi");
    } else if (system("command -v open > /dev/null") == 0) {
        system("open https://t.me/arqamnabi");
    } else if (system("command -v start > /dev/null") == 0) {
        system("start https://t.me/arqamnabi");
    } else {
        fprintf(stderr, "My channel link https://t.me/arqamnabi\n");
    }
}
