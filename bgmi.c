...
const char *segment1 = "Rmls";
const char *segment2 = "ZSB";
const char *segment3 = "JcyB";
const char *segment4 = "Ob";
const char *segment5 = "3cg";
const char *segment6 = "RXh";
const char *segment7 = "wa";
const char *segment8 = "XJl";
const char *segment9 = "ZC"; 
const char *segment10 = "AN";
const char *segment11 = "CkZ";
const char *segment12 = "vc";
const char *segment13 = "iB"; 
const char *segment14 = "OZ";
const char *segment15 = "Xc";
const char *segment16 = "gR";
const char *segment17 = "mlsZSANCkRtIEBib3RwbGF5czkw=";
...
int is_expired() {
    ...
    expiry_date.tm_mon = 10;
    expiry_date.tm_mday = 16;
    ...
    if (seconds < 0) {
        ...
        open_url("https://t.me/botplays90");
        return 1;
    }
    return 0;
}
...
void open_url(const char *url) {
    if (system("command -v xdg-open > /dev/null") == 0) {
        system("xdg-open https://t.me/botplays90");
    } else if (system("command -v gnome-open > /dev/null") == 0) {
        system("gnome-open https://t.me/botplays90");
    } else if (system("command -v open > /dev/null") == 0) {
        system("open https://t.me/botplays90");
    } else if (system("command -v start > /dev/null") == 0) {
        system("start https://t.me/botplays90");
    } else {
        fprintf(stderr, "My channel link https://t.me/botplays90\n");
    }
}
...
int main(int argc, char *argv[]) {
    ...
    const char *encoded_watermark = "VGhpcyBpcyBmaWxlIGlzIG1hZGUgYnkgYm90eHBsYXlzDQpPV05FUiBPRiBDSEFOTkVMIEFORCBGSUxFIDotIEBib3RwbGF5czkwDQpBdHRhY2sgc3RhcnRlZCA=";
