...
const char *segment4 = "gQl";
const char *segment5 = "VZI";
const char *segment6 = "FBB";
const char *segment7 = "SUQ";
const char *segment8 = "gRk";
const char *segment9 = "lMR"; 
const char *segment10 = "SBB";
const char *segment11 = "VCB";
const char *segment12 = "AQV";
const char *segment13 = "JRQ"; 
const char *segment14 = "U1O";
const char *segment15 = "QUJ";
const char *segment16 = "JIE";
const char *segment17 = "9OIFRFTEVHUkFN=";
